...
class _TrainerScheduleScreenState extends State<TrainerScheduleScreen>
  ...
  // Students List for One-to-One selection
  final List<Map<String, dynamic>> _studentsList = [
    {'name': 'Marcus Chen', 'avatar': 'MC', 'email': 'marcus.chen@example.com', 'level': 'Advanced'},
    {'name': 'Elena Rodriguez', 'avatar': 'ER', 'email': 'elena.r@example.com', 'level': 'Intermediate'},
    {'name': 'Sarah Johnson', 'avatar': 'SJ', 'email': 'sarah.j@example.com', 'level': 'Elite'},
    {'name': 'Mike Chen', 'avatar': 'MC', 'email': 'mike.chen@example.com', 'level': 'Beginner'},
    {'name': 'Emma Davis', 'avatar': 'ED', 'email': 'emma.d@example.com', 'level': 'Advanced'},
    {'name': 'Alex Rivera', 'avatar': 'AR', 'email': 'alex.r@example.com', 'level': 'Intermediate'},
  ];
  
  // Today's Sessions
  final List<Map<String, dynamic>> _todaySessions = [
    {'title': 'Elite Strength & Conditioning', 'time': '08:00 AM', 'status': 'live', 'current': 3, 'capacity': 12, 'duration': '60 min', 'type': 'Group'},
    {'title': 'Advanced Yoga Flow', 'time': '04:00 PM', 'status': 'upcoming', 'current': 18, 'capacity': 25, 'duration': '45 min', 'type': 'Group'},
  ];
        ...
        children: [
          Row(
            ...
            children: [
              IconButton(
                ...
                icon: Icon(Icons.chevron_left, color: Colors.cyan),
              ),
              Text(
              ...
              IconButton(
                ...
                icon: Icon(Icons.chevron_right, color: Colors.cyan),
              ),
            ],
          ),
            ...
            children: ['MON', 'TUE', 'WED', 'THU', 'FRI', 'SAT', 'SUN'].map((day) {
              return Expanded(
                child: Center(
                  child: Text(
                    day,
                    style: GoogleFonts.poppins(color: Colors.cyan, fontSize: 11.sp, fontWeight: FontWeight.bold),
                  ),
                ),
              );
            }).toList(),
          ...
          GridView.builder(
            ...
            itemBuilder: (context, index) {
              int dayIndex = index - (firstWeekday - 1);
              if (dayIndex >= 1 && dayIndex <= daysInMonth) {
                DateTime day = days[dayIndex - 1];
